...
function formCheck(name, phone, time) {
    ...
    if (name == '' || name.length < 2 || phone == '' || phone.length < 17) {
                ...
                success: function(html) {
                       ...
                       $(".modal_shadow").fadeIn();
                       $("body").append('<div class="message"><div class="close"><a href="http://centralpark.moscow"><img src="img/close.png" alt="close" onclick="hidemessage();" /></a></div>Спасибо, Ваша заявка принята.<br /> Наш менеджер обязательно<br /> с Вами свяжется.<br /> <p>С Уважением, © LER Group Ltd.</p></div>');
                       $(".message").fadeIn();
